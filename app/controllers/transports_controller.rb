...
before_filter :login_required
  ...
  def create
   ...
   @data=MgTransport.new(transport_params)
    ...
    vehicle_data.updated_by=session[:user_id]
    vehicle_data.save
...
if vehicle_data.length>0
  ...
  def update_data
    @vehicle_route=MgTransport.find(params[:id])
     ...
     @vehicle_route.update(edit_transport_params)
      @vehicle_route.update_attribute(:updated_by,session[:user_id])
  ...
  def destroy
    ...
    @vehicle_route.updated_by=session[:user_id]
  ...
  def transport_time_management_create
    ...
    pick_up_start_time_hour=params[:pick_up_time]["game_time(4i)"]
     ...
     transport_time_details.updated_by=session[:user_id]
  ...
  def transport_time_management_update
    ...
    drop_time=drop_time_hour+":"+drop_time_hour_min+":00";
     ...
     @transport_time_update.update(:pick_up_time=>start_time,:drop_time=>drop_time,:updated_by=>session[:user_id])
  ...
  def transport_time_management_destroy
    ...
    @transport_time_destroy.updated_by =session[:user_id]
...
def student_status_data
  ...
  def   transport_fee_category_create
    ...
    @feedetails.created_by=session[:user_id]
    @feedetails.updated_by=session[:user_id]
    @feedetails.save
    ...
    settings_data.save
                     ...
                     for i in 0...@particularData.size
                      ...
                      @saveParticular.created_by=session[:user_id]
                      @saveParticular.updated_by=session[:user_id]
                      @saveParticular.save
                     end
...
def transport_fee_category_update
  ...
  @particulartype.update(:particular_name=>@updateparticulars[i],:updated_by=>session[:user_id])
else
  ...
  @particular.mg_fee_category_id=params[:id]
   ...
   @particular.created_by=session[:user_id]
   @particular.updated_by=session[:user_id]
...
#logger.infosd
     ...
     if @feeCategoryObj.update(subject_params)
        @feeCategoryObj.update(:updated_by=>session[:user_id])
       redirect_to :action=>'transport_fee_category'
     else
