...
def create_payment
  ...
  gateway=MgPaymentGateway.new(:mg_master_payment_type_id=>params[:mg_master_payment_type],:mg_wing_id=>params[:mg_wing_id],:time_table_year=>params[:time_table_year],:mg_employee_specialization_id=>params[:mg_employee_specialization_id],:mg_alumni_id=>params[:mg_alumni_id],:amount=>params[:alumni_pay][:amount],:is_deleted=>0,:mg_school_id=>session[:current_user_school_id],:created_by=>session[:user_id],:mg_finance_fee_id=>mgtransaction.id)
  gateway.save
...
def alumni_data
    alumni_data_attended=MgAlumniProgrammeAttended.where(:is_deleted=>0,:mg_school_id=>session[:current_user_school_id],:mg_wing_id=>params[:mg_wing_id],:time_table_year=>params[:year],:mg_employee_specialization_id=>params[:id]).pluck(:mg_alumni_id).uniq
