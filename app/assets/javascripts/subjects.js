...
function subject_type_Changes(subject_type_id){
  if(subject_type_id==1){
    $("#mg_subject_mg_elective_group_id").val('');
    $("#mg_subject_mg_elective_group_id").attr('disabled','disabled');
  }
  else{
    $("#mg_subject_mg_elective_group_id").removeAttr('disabled');
  }
}

 $(document).on("change","#mg_subject_mg_elective_group_id",function(){
    var elective_group_id=$(this).val();
    $.ajax({
      url:"/subjects/elective_type",
      data:{"mg_elective_group_id":elective_group_id},
      success:function(data){
        console.log(data);
        $("#elective_type").val(data);
      }
    });
  });