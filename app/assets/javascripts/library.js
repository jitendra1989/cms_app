...
$.ajax({
            ...
            cache:false,
            data:{"no_of_days_delayed":id_data,"extent_of_damage":dta_id,"fine_amount":data_id,"account_id":account,"inventory_id":myIDs,"boolean_data":boolean_data},
            success: function(data){
              $("#student_employee_data_info").empty();
