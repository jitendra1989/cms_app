          ...
          $.ajax({
            ...
            success: function(data)
            {
                ...
                if(data.employee.length > 0){   
                   ...
                   var str='<div class="mg-scroll-employee-bar mg-tbl-margin" style="width: 50%;"><table class="batch-tbl" cellspacing="0" style="padding:0; height:100%; border-collapse:collapse;"><tr class="subject-table-header" rowspan="2"><th>First Name</th><th>Last Name</th><th>action</th></tr>';
              //     $("#employeeLeaveSelectID").append(str);
