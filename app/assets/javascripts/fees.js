  ...
  $(document).on("click", ".show_class", function(e){
      ...
      //  alert(urlLink);
        $.ajax({
            ...
            cache: false,
            success: function(html){
                  $('#showFeeCaregoryDivID').dialog({
                    modal: true,
                    title: "Show Fee Category",
                    width: 'auto',
                    open: function () {
                        $(this).html(html);
                    }
    ...
    if(feeCategoryId.trim()!='')
    {
        $.ajax({
            ...
            success: function(data)
            {
                ...
                console.log(data);
                $("#batchDetailId").empty();
                $("#batchDetailId").append('<label class="mg-label">Select Semester</label><br/>');
            ...
            if(data.studentList.length>0)
                {
                    ...
                    str +='<th>Student name</th><th>Action</th>';
                    ...
                    for (var key in data.studentList) 
                    {
                        ...
                        str ='<tr><td>'+firstName+' '+ lastName+'</td><td class="mg-align-center"><a class="mg-icon-btn" title="View" href="/fees/defaulter_fees_submission/'+studentId+'" ><i class="fa fa-eye"></i></a></td></tr>';
                        $("#feeDefaulterStudentListID").append(str);
                        str='';
                    }
                }
            ...
            console.log(data);
                ...
                if(data.studentList.length>0)
                {
                    ...
                    for (var key in data.studentList) 
                    {
                        ...
                        str ='<tr><td>'+firstName+' '+ lastName+'</td><td class="mg-align-center"><a title="View" class="mg-icon-btn" href="/fees/fees_submission_batch/'+studentId+'/'+data.collectionID+'" ><i class="fa fa-eye"></i></a></td></tr>';
                        $("#feeCollectionStudentListID").append(str);
                        str='';
                    }
            ...
            success: function(data)
            {
                ...
                if(data.studentList.length>0)
                {
                    ...
                    for (var key in data.studentList) 
                    {
                        ...
                        middleName=d2.middle_name;
                        lastName=d2.last_name;
                        str ='<tr><td>'+firstName+' '+ lastName+'</td><td class="mg-align-center"><a title="View" class="mg-icon-btn" href="/fees/fees_submission_batch/'+studentId+'/'+selectFeeScheduleId+'" ><i class="fa fa-eye"></i></a></td></tr>';
                        $("#feeCollectionStudentListID").append(str);
                        str='';
                    }
                }
    ...
    if(feeCategoryId.trim()!='')
    {
        $.ajax({
            ...
            success: function(data)
            {
                console.log(data);
                $("#batchDetailFeeCollectionID").empty();
                $("#batchDetailFeeCollectionID").append('<label class="mg-label">Select Semester</label><br/>');
                ...
                if(data.batch_details.length>0)
                {
                    ...
                    for (var key = 0 ;key< dataArray.length;key++) 
                    {
                        ...
                        console.log(d2[0]); 
                        batch_name=d2[3]+'-'+d2[1];
                        str +='<input type="checkbox" name="selected_batch[]" value="'+batch_id+'" class="batchId_checkbox_cls auto-ckeckbox-fee-schedule-batch-cls">'+batch_name+'<br/>'
                   }
                    str+='</div>';
            ...
            console.log(data);
                ...
                if(data.studentList.length>0)
                {
                    ...
                    for (var key in data.studentList) 
                    {
                        ...
                        str +='<tr><td>'+firstName+' '+ lastName+'</td><td class="mg-align-center"><a title="View" class="mg-icon-btn select-student-fee-report" id="'+studentId+'-feeReportAID" ><i class="fa fa-eye"></i></a></td></tr>';
                        //$("#feeCollectionReportStudentListID").append(str);
                        //str='';
                    }
                    str+='</table></div>';
