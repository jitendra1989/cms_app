...
$(document).on("click", ".delete-emp-spec-btn", function(e){
     e.preventDefault();
            ...
            var Id=myID.split("-");
                ...
                if(retVal){
                  //  alert(retVal);
                     var urlLink = "/employees/specialization_delete/"+Id[0];
                      $.ajax({
                        url: urlLink ,
                        cache: false,
...
$(document).on("click", ".delete-emp-doc-btn", function(e){
     e.preventDefault();
                var myID =$(this).attr('id');
            var Id=myID.split("-");
                var retVal = confirm("Are you sure to delete?");
                if(retVal){
                  //  alert(retVal);
                     var urlLink = "/employees/document_delete/"+Id[0];
                      $.ajax({
                        url: urlLink ,
                        cache: false,
                        success: function(html){
