class ReportPdf < Prawn::Document
  def initialize(student_name,exam_detail,course_name,school_logo,school,date_format,session_id)
    ...
    #repeat :all do
      ...
      move_down(13)
      draw_text "Semester: #{@course_name.try(:course_name)} #{@batch_name.try(:name)}", :at => [-40, cursor], :size => 12
     
      stroke do
        rectangle [300, 200], 85, 85
      end
      move_down(45)
  ...
  def product_rows
    ...
    [['Exam Date', 'Start Time', 'End Time','Venue Address']] +
