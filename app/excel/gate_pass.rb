class GatePass < WriteXLSX
	...
	def gate_pass_excel
	    ...
	    coloum_no_h=0
		    ...
		    w.write(8, coloum_no_h, 'Contact Person',heading_left)
		    w.write(9, coloum_no_h, 'Street Address',heading_left)
		    w.write(10, coloum_no_h, 'City',heading_left)
		    w.write(11, coloum_no_h, 'State',heading_left)
		    w.write(12, coloum_no_h, 'Pincode',heading_left)
		    w.write(13, coloum_no_h, 'Country',heading_left)
		    w.write(14, coloum_no_h, 'Phone Number',heading_left)
		    w.write(15, coloum_no_h, 'Fax Number',heading_left)
		    w.write(15, coloum_no_h, 'email id',heading_left)
		    w.write(15, coloum_no_h, 'Information',heading_left)
	    coloum_no_d=1
		    w.write(7, coloum_no_d, @vendors.try(:name).try(:capitalize))
		    w.write(8, coloum_no_d, @vendors.try(:contact_name).try(:capitalize))
		    w.write(9, coloum_no_d, @vendors.try(:street_address).try(:capitalize))
		    w.write(10, coloum_no_d, @vendors.try(:city).try(:capitalize))
		    w.write(11, coloum_no_d, @vendors.try(:state).try(:capitalize))
		    w.write(12, coloum_no_d, @vendors.try(:postal_code).try(:capitalize))
		    w.write(13, coloum_no_d, @vendors.try(:country).try(:capitalize))
		    w.write(14, coloum_no_d, @vendors.try(:phone_number).try(:capitalize))
		    w.write(15, coloum_no_d, @vendors.try(:fax_number).try(:capitalize))
		    w.write(15, coloum_no_d, @vendors.try(:email).try(:capitalize))
		    w.write(15, coloum_no_d, @vendors.try(:information).try(:capitalize))
