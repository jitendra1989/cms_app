...
#hostel management added by balaji
  ...
  get 'placements/placement_head_resetpassword'=> 'placements#placement_head_resetpassword'
  get 'placements/update_placement_head_resetpassword'=> 'placements#update_placement_head_resetpassword'
  get 'placements/:id/resetpassword'=>"placements#resetpassword"
  get 'placements/password_search_data' => 'placements#password_search_data'
  get 'placements/:id/resetpassword_recruit'=>"placements#resetpassword_recruit"
  get 'placements/:id/resetpassword_corporate'=>"placements#resetpassword_corporate"



  get 'placements/:id/training_request_reject'=>"placements#training_request_reject"


  get 'placements/placements_registration'=>'placements#placements_registration',as: :placements_registration
  get 'placements/:id/placements_registration_edit'=>'placements#placements_registration_edit',as: :placements_registration_edit
  get 'placements/placements_registration_new'=>'placements#placements_registration_new',as: :placements_registration_new
  get 'placements/:id/placements_registration_show'=>'placements#placements_registration_show',as: :placements_registration_show
  post 'placements/placements_registration_create'=>'placements#placements_registration_create',as: :placements_registration_create
  patch 'placements/:id/placements_registration_update'=>'placements#placements_registration_update',as: :placements_registration_update
  get 'placements/:id/placements_registration_delete'=>'placements#placements_registration_delete',as: :placements_registration_delete
  get 'placements/job_upload'=>'placements#job_upload'
  get '/placements/placement_registration_password/:id'=>"placements#placement_registration_password"
  get 'placements/placement_change_password'

  get 'placements/placement_training_required_new'=>'placements#placement_training_required_new'
  get 'placements/:id/placement_training_required_edit'=>'placements#placement_training_required_edit'
  get 'placements/placement_training_required_index'=>'placements#placement_training_required_index',as: :placement_training_required_index
  get 'placements/placement_training_required_show/:id'=>'placements#placement_training_required_show',as: :placement_training_required_show
  post 'placements/placement_training_required_create'=>'placements#placement_training_required_create'
  patch 'placements/:id/placement_training_required_update'=>'placements#placement_training_required_update'
  get 'placements/placement_training_required_delete/:id'=>'placements#placement_training_required_delete'
  

  get 'placements/interview_rounds'=>'placements#interview_rounds',as: :interview_rounds
  get 'placements/interview_rounds_new'=>'placements#interview_rounds_new',as: :interview_rounds_new
  get 'placements/:id/interview_rounds_edit'=>'placements#interview_rounds_edit',as: :interview_rounds_edit
  post 'placements/interview_rounds_create'=>'placements#interview_rounds_create',as: :interview_rounds_create
  patch 'placements/:id/interview_rounds_update'=>'placements#interview_rounds_update',as: :interview_rounds_update
  get 'placements/:id/interview_rounds_delete'=>'placements#interview_rounds_delete',as: :interview_rounds_delete
  get 'placements/:id/interview_rounds_show'=>'placements#interview_rounds_show',as: :interview_rounds_show


    get 'placements/corporate_profile_update'=>'placements#corporate_profile_update',as: :corporate_profile_update
#jayanth
    get 'placements/corporate_profile_edit/:id'=>'placements#corporate_profile_edit',as: :corporate_profile_edit

        get 'placements/:id/training_offered_list'=>'placements#training_offered_list',as: :training_offered_list

    get 'placements/corporate_profile'=>'placements#corporate_profile',as: :corporate_profile

    get 'placements/placement_training_offered_list'=>'placements#placement_training_offered_list',as: :placement_training_offered_list


    get 'placements/placement_training_offered_accept'=>'placements#placement_training_offered_accept',as: :placement_training_offered_accept
    get 'placements/filter_company_data_training'=>'placements#filter_company_data_training',as: :filter_company_data_training

    get 'training_offered'=>'placements#training_offered',as: :training_offered
    get 'placements#training_offered_new'=>'placements#training_offered_new',as: :training_offered_new
    get 'placements/training_offered_create'=>'placements#training_offered_create',as: :training_offered_create
    get 'placements/:id/training_offered_edit'=>'placements#training_offered_edit',as: :training_offered_edit
    get 'placements/training_offered_update'=>'placements#training_offered_update',as: :training_offered_update
    get 'placements/:id/training_offered_delete'=>'placements#training_offered_delete',as: :training_offered_delete
    get 'placements/:id/training_offered_show'=>'placements#training_offered_show',as: :training_offered_show
    get 'placements/training_offered_validation'
   
    get 'placements/job_apply'=>'placements#job_apply',as: :job_apply
    get 'placements/job_apply_new'=>'placements#job_apply_new',as: :job_apply_new
    get 'placements/job_apply_create'=>'placements#job_apply_create',as: :job_apply_create
    get 'placements/job_apply_update'=>'placements#job_apply_update',as: :job_apply_update
    get 'placements/:id/job_apply_edit'=>'placements#job_apply_edit',as: :job_apply_edit
    get 'placements/:id/job_apply_show'=>'placements#job_apply_show',as: :job_apply_show
    get 'placements/:id/job_apply_delete'=>'placements#job_apply_delete',as: :job_apply_delete
    get 'placements/onchange_data'=>'placements#onchange_data',as: :onchange_data
    get 'placements/readonly_data'=>'placements#readonly_data',as: :readonly_data
    get 'placements/onchange_data_edit'=>'placements#onchange_data_edit',as: :onchange_data_edit
    get 'placements/select_data_based_on_semester_graph_data'=>'placements#select_data_based_on_semester_graph_data',as: :select_data_based_on_semester_graph_data

      #get 'placements/placement_report'

    get 'placements/send_notification'=>'placements#send_notification',as: :send_notification
    get 'placements/placement_student_selection'=>'placements#placement_student_selection',as: :placement_student_selection
    get 'placements/:id/placement_student_selection_edit'=>'placements#placement_student_selection_edit',as: :placement_student_selection_edit
    get 'placements/placement_student_selection_create'=>'placements#placement_student_selection_create',as: :placement_student_selection_create

      get 'placements/student_status_report'
      get 'placements/placement_report'
      get 'placements/select_data_based_on_semester_graph'
      
      get 'placements/select_data_based_on_semester'
      get 'placements/:id/placement_student_selection_show'=>'placements#placement_student_selection_show',as: :placement_student_selection_show
      get 'placements/interview_status_for_student'
      get 'placements/student_selection'
      get 'placements/student_selection_new'
      get 'placements/select_students_on_job'
      get 'placements/select_students_on_job_edit'
      get 'placements/student_selection_create'=>'placements#student_selection_create',as: :student_selection_create
      get 'placements/:id/student_selection_show'=>'placements#student_selection_show',as: :student_selection_show
      get 'placements/:id/student_selection_edit'=>'placements#student_selection_edit',as: :student_selection_edit
      get 'placements/:id/student_selection_delete'=>'placements#student_selection_delete',as: :student_selection_delete
      get 'placements/student_selection_update'=>'placements#student_selection_update',as: :student_selection_update
      get 'placements/interview_status'=>'placements#interview_status',as: :interview_status


# balaji's
    get 'placements/job_upload'=>"placements#job_upload"
    get 'placements/job_upload_new'=>'placements#job_upload_new'
    get 'placements/job_upload_create'=>'placements#job_upload_create'
    get 'placements/:id/job_upload_show'=>"placements#job_upload_show"
    patch 'placements/:id/job_upload_update'=>"placements#job_upload_update"
    get 'placements/job_upload_accept'=>'placements#job_upload_accept'
    get 'placements/:id/training_request_accept'=>"placements#training_request_accept"
    get 'placements/:id/job_upload_reject'=>"placements#job_upload_reject"
    get 'placements/filter_company_data'=>"placements#filter_company_data"
    get 'placements/placement_training_requested_show'=>"placements#placement_training_requested_show"
    get 'placements/:id/job_upload_show_student'=>"placements#job_upload_show_student"

    get 'placements/:id/placement_training_requested_show'=>"placements#placement_training_requested_show"
    get 'placements/placement_training_status_update'=>"placements#placement_training_status_update"
    
    get 'placements/:id/job_upload_show_student'=>"placements#job_upload_show_student"

    get 'placements/:id/student_doc_edit'=>'placements#student_doc_edit'
    
      get 'placements/index'

    
 get 'placements/placement_student_detail_index'=>'placements#placement_student_detail_index',as: :placement_student_detail_index
  get 'placements/placement_student_detail_new'=>'placements#placement_student_detail_new',as: :placement_student_detail_new
  post 'placements/placement_student_detail_create'=>'placements#placement_student_detail_create',as: :placement_student_detail_create
  get 'placements/placement_student_detail_edit/:id'=>'placements#placement_student_detail_edit',as: :placement_student_detail_edit
  patch 'placements/:id/placement_student_detail_update'=>'placements#placement_student_detail_update',as: :placement_student_detail_update
  delete 'placements/placement_student_detail_delete/:id'=>'placements#placement_student_detail_delete',as: :placement_student_detail_delete
  get 'placements/placement_student_detail_show/:id'=>'placements#placement_student_detail_show',as: :placement_student_detail_show
  
  get 'placements/student_uploaded_resume_index'=>'placements#student_uploaded_resume_index',as: :student_uploaded_resume_index
  get 'placements/student_resume_upload_new'=>'placements#student_resume_upload_new',as: :student_resume_upload_new
  post 'placements/student_resume_upload_create'=>'placements#student_resume_upload_create',as: :student_resume_upload_create
  get 'placements/change_default_resume/:id'=>'placements#change_default_resume',as: :change_default_resume
  delete 'placements/delete_student_resume/:id'=>'placements#delete_student_resume',as: :delete_student_resume
  get 'placements/student_resume_upload_show/:id'=>'placements#student_resume_upload_show',as: :student_resume_upload_show
 
  get 'placements/index_corporate_login'=>'placements#index_corporate_login',as: :index_corporate_login
  get 'placements/index_placement_cell_head'=>'placements#index_placement_cell_head',as: :index_placement_cell_head
  get 'placements/index_recruitment_assistant'=>'placements#index_recruitment_assistant',as: :index_recruitment_assistant
  get 'placements/new_user'=>'placements#new_user',as: :new_user
  post 'placements/create_user'=>'placements#create_user',as: :create_user
  get 'placements/edit_user/:id'=>'placements#edit_user',as: :edit_user
  patch 'placements/:id/update_user'=>'placements#update_user',as: :update_user
...
get 'sessions/database_details'
get 'sessions/login_details'
  ...
  get 'posts/edit'
  get 'posts/delete'
  get 'posts/update_data'
  get 'posts/show'
  get 'posts/destroy_session'
  get 'posts/registration_sign_up' => 'posts#registration_sign_up'
  get 'posts/registration_create' => 'posts#registration_create'
  get 'posts/registration_sign_in' => 'posts#registration_sign_in'
  get 'posts/registration_sign_in_create' => 'posts#registration_sign_in_create'
  get 'posts/email_search_data' => 'posts#email_search_data'
...
get 'exam_management/show_examination_grades'
get 'exam_management/examination_grades'
get 'exam_management/examination_grades_show'
get 'exam_management/examination_grades_add_grades'
get 'exam_management/examination_grades_add_new_grade'
get 'exam_management/examination_grades_edit'
get 'exam_management/examination_grades_update'
get 'exam_management/examination_grades_destroy'



 get 'dashboards/query_record_index_data', as: :query_record_index_data
 get 'dashboards/controller_question_paper'
 get 'dashboards/controller_question_paper_list'
  
 get 'dashboards/employee_question_paper'
  get 'dashboards/employee_question_paper_new'
  post 'dashboards/employee_question_paper_create'=>'dashboards#employee_question_paper_create', as: :question_paper_create
  # post 'dashboards/employee_question_paper_create'
  get 'dashboards/employee_question_paper_show'
  get 'dashboards/employee_question_paper_edit'=>'dashboards#employee_question_paper_edit', as: :question_paper_edit
  get 'dashboards/employee_question_paper_update'




  get 'dashboards/exam_management_select_class'
  get 'dashboards/exam_management_select_section'
  get 'dashboards/exam_management_select_subject'
  get 'dashboards/delete_record_data'
  get 'dashboards/hod_question_paper'
  
  get 'dashboards/employee_question_paper_hod'

  
  get 'dashboards/hod_question_paper_list'
get 'exam_management/exam_fee_category'
 get 'exam_management/exam_fee_category_new'
 get 'exam_management/exam_fee_category_create'
 get 'exam_management/transport_fee_category_show'
 get 'exam_management/exam_fee_category_edit'
 get 'exam_management/exam_fee_category_update'
 get 'exam_management/delete_transport_fee_category'

 get 'exam_management/manage_exam_particulars'
 get 'exam_management/manage_exam_particulars_new'
 get 'exam_management/manage_exam_particulars_create'
  get 'exam_management/exam_edit_fee_particular'
  get 'exam_management/exam_update_fee_particular'
  get 'exam_management/exam_destroy_fee_particular'
 # get 'exam_management/delete_transport_fee_category'
  get 'exam_management/examination_fee_schedule'
 
  get 'exam_management/examination_delete_fee_schedule'
 
 get 'subject_specialization'=>'exam_management#subject_specialization',as: :subject_specialization
  get 'subject_specialization/new'=>'exam_management#new_subject_specialization',as: :new_subject_specialization
  get 'subject_specialization/:id/edit'=>'exam_management#edit_subject_specialization',as: :edit_subject_specialization
  post 'exam_management/create_subject_specialization'=>'exam_management#create_subject_specialization',as: :create_subject_specialization
  get 'exam_management/:id/show_subject_specialization'=>'exam_management#show_subject_specialization', as: :show_subject_specialization
  patch 'exam_management/:id/update_subject_specialization'=>'exam_management#update_subject_specialization', as: :update_subject_specialization
  get 'exam_management/:id/delete_subject_specialization'=>'exam_management#delete_subject_specialization', as: :delete_subject_specialization
  get 'subject_specialization_details'=>'exam_management#subject_specialization_details',as: :subject_specialization_details




  # get 'exam_management/exam_types'=>'exam_management#exam_types',as: :exam_types
  # get 'exam_management/exam_types/new'=>'exam_management#exam_types#new',as: :new_exam_types
  # get 'exam_management/exam_types/edit/:id'=>'exam_management#exam_types#edit',as: :edit_exam_types
 get 'exam_management/change_credential'
 get 'exam_management/student_details_excel_sheet'
 get 'exam_management/select_employee_for_specialization'
 

  get 'exam_management/show_hod_login_credentials'=>"exam_management#show_hod_login_credentials",as: :show_hod_login_credentials
  get 'exam_management/change_hod_login_password'=>"exam_management#change_hod_login_password",as: :change_hod_login_password

 get 'exam_management/unique_username'
 get 'exam_management/index_hod_login'
 get 'exam_management/new_hod_login'
 get 'exam_management/create_hod_login'
 get 'exam_management/edit_hod_login'=>"exam_management#edit_hod_login",as: :edit_hod_login
 get 'exam_management/update_hod_login'
 get 'exam_management/login_information'

get 'exam_management/show_hod_login/:id'=>"exam_management#show_hod_login",as: :show_hod_login
get 'exam_management/delete_hod_login/:id'=>"exam_management#delete_hod_login",as: :delete_hod_login
  get 'exam_management/store_manager_change_password'=>"exam_management#store_manager_change_password"#,as: :store_manager_change_password
  
 


 get 'exam_management/generate_exam_report'
 get 'exam_management/select_student_for_report'
 get 'exam_management/report_generation_for_student_data'
 get 'exam_management/generate_report_pdf'
 get 'exam_management/examination_details_for_course_evaluation'
 
 
 get 'exam_management/examination_marks_entry_for_subject_marks_evaluation'
 

 get 'exam_management/examination_details_for_subject'
  
  get 'exam_management/examination_details_for_course'
  get 'exam_management/examination_details_for_program'

  get 'exam_management/Examination_evaluation_data'
  get 'exam_management/examination_evaluation_create'
  get 'exam_management/exam_evaluation_data_edit/:id'=>'exam_management#exam_evaluation_data_edit', as: :exam_evaluation_data_edit
  get 'exam_management/exam_evaluation_data_show/:id'=>'exam_management#exam_evaluation_data_show', as: :exam_evaluation_data_show
  get 'exam_management/exam_evaluation_data_update'
  get 'exam_management/exam_evaluation_data_destroy'
  get 'exam_management/examination_marks_sheet_details'
  get 'exam_management/examination_marks_sheet_details_new'
  get 'exam_management/examination_marks_details_for_subject'
  get 'exam_management/examination_marks_entry_for_subject_marks'
  get 'exam_management/examination_marks_entry_create'
  get 'exam_management/examination_marks_sheet_details_show'=>'exam_management#examination_marks_sheet_details_show',as: :examination_marks_sheet_details_show
  get 'exam_management/examination_marks_sheet_details_edit'=>'exam_management#examination_marks_sheet_details_edit',as: :examination_marks_sheet_details_edit

get 'exam_management/issue_exam_application'

  get 'exam_management/issue_exam_application_new'
  get 'exam_management/issue_exam_application_show/:id'=>'exam_management#issue_exam_application_show', as: :issue_exam_application_show

  get 'exam_management/issue_exam_application_create'

  get 'exam_management/select_class_based_on_wing'
  get 'exam_management/select_students'

  get 'exam_management/select_students_edit'
  get 'exam_management/issue_exam_application_update'
  get 'exam_management/issue_exam_application_destroy'
  


  
  get 'exam_management/hall_ticket_pdf'=>'exam_management#hall_ticket_pdf', as: :hall_ticket_pdf
  get 'exam_management/exam_admit_card'=>'exam_management#exam_admit_card', as: :exam_admit_card
  get 'exam_management/mg_student_show'=>'exam_management#mg_student_show', as: :mg_student_show
  get 'exam_management/batch_wise_students'=>'exam_management#batch_wise_students', as: :batch_wise_students
  get 'exam_management/select_wing'=>'exam_management#select_wing', as: :select_wing
  get 'exam_management/exam_hall_ticket'=>'exam_management#exam_hall_ticket', as: :exam_hall_ticket
  
  get 'exam_management/program_category_data'

  get 'exam_management/program_category_data_new'
  get 'exam_management/program_category_create'
  get 'exam_management/program_category_edit'
  get 'exam_management/program_category_update'
  get 'exam_management/controller_examiner_show'
  get 'exam_management/assaign_exam_management_new'
  get 'exam_management/assaign_exam_controller_create'
  get 'exam_management/assaign_exam_management_edit'
  get 'exam_management/assaign_exam_management_update'


  post 'exam_management/create'=>'exam_management#create', as: :exam_management_create
  
  get 'exam_management/examination_category'=>'exam_management#examination_category', as: :examination_category
  get 'exam_management/examination_category_new'=>'exam_management#examination_category_new', as: :examination_category_new
  get 'exam_management/examination_category_edit/:id'=>'exam_management#examination_category_edit', as: :examination_category_edit
  post 'exam_management/examination_category_create'=>'exam_management#examination_category_create', as: :examination_category_create
  patch 'exam_management/examination_category_update/:id'=>'exam_management#examination_category_update', as: :examination_category_update
  get 'exam_management/examination_category_delete/:id'=>'exam_management#examination_category_delete', as: :examination_category_delete
  get 'exam_management/examination_category_show/:id'=>'exam_management#examination_category_show', as: :examination_category_show
  
  get 'exam_management/examination'=>'exam_management#examination', as: :examination_creation
  get 'exam_management/new_examination'=>'exam_management#new_examination', as: :new_examination
  get 'exam_management/:id/edit_examination'=>'exam_management#edit_examination', as: :edit_examination
  post 'exam_management/create_examination'=>'exam_management#create_examination', as: :create_examination
  get 'exam_management/:id/show_examination'=>'exam_management#show_examination', as: :show_examination
  patch 'exam_management/:id/update_examination'=>'exam_management#update_examination', as: :update_examination
  get 'exam_management/:id/delete_examination'=>'exam_management#delete_examination', as: :delete_examination

  get 'exam_management/multi_skilled_worker'=>'exam_management#multi_skilled_worker', as: :multi_skilled_worker

  get 'exam_management/invigilators'=>'exam_management#invigilators',as: :invigilators
  get 'exam_management/new_invigilators'=>'exam_management#new_invigilators',as: :new_invigilators
  get 'exam_management/:id/edit_invigilators'=>'exam_management#edit_invigilators',as: :edit_invigilators
  get 'exam_management/:id/show_invigilators'=>'exam_management#show_invigilators',as: :show_invigilators
  post 'exam_management/create_invigilators'=>'exam_management#create_invigilators',as: :create_invigilators
  patch 'exam_management/:id/update_invigilators'=>'exam_management#update_invigilators',as: :update_invigilators
  get 'exam_management/:id/delete_invigilators'=>'exam_management#delete_invigilators',as: :delete_invigilators
  get 'exam_management/invigilators_details'=>'exam_management#invigilators_details',as: :invigilators_details
  get 'exam_management/invigilation_details'=>'exam_management#invigilation_details',as: :invigilation_details

  get 'exam_management/time_table'=>'exam_management#time_table',as: :exam_time_table
  get 'exam_management/new_time_table'=>'exam_management#new_time_table',as: :new_time_table
  get 'exam_management/:id/edit_time_table'=>'exam_management#edit_time_table',as: :edit_time_table
  get 'exam_management/:id/show_time_table'=>'exam_management#show_time_table',as: :show_time_table
  patch 'exam_management/:id/update_time_table'=>'exam_management#update_time_table',as: :update_time_table
  get 'exam_management/:id/delete_time_table'=>'exam_management#delete_time_table',as: :delete_time_table
  post 'exam_management/create_time_table'=>'exam_management#create_time_table',as: :create_time_table

  get 'exam_management/subject_list/:id'=>'exam_management#subject_list', as: :exam_management_subject_list
  get 'exam_management/exam_time_table_show'=>'exam_management#exam_time_table_show',as: :exam_time_table_show

  get 'seating_plan'=>'exam_management#seating_plan',as: :seating_plan
  get 'seating_plan/new'=>'exam_management#new_seating_plan',as: :new_seating_plan
  get 'seating_plan/:id/edit'=>'exam_management#edit_seating_plan',as: :edit_seating_plan
  get 'seating_plan/:id/show'=>'exam_management#show_seating_plan',as: :show_seating_plan
  patch 'exam_management/:id/update_seating_plan'=>'exam_management#update_seating_plan',as: :update_seating_plan
  post 'exam_management/create_seating_plan'=>'exam_management#create_seating_plan',as: :create_seating_plan
  get 'seating_plan/:id/delete'=>'exam_management#delete_seating_plan',as: :delete_seating_plan
  get 'exam_management/excel'=>'exam_management#excel',as: :exam_excel
  get 'exam_management/generate_excel/:id'=>'exam_management#generate_excel',as: :exam_generate_excel
  get 'exam_notification'=>'exam_management#exam_notification',as: :exam_notification
  post 'exam_management/send_notification'=>'exam_management#send_notification',as: :exam_management_send_notification

  #Bindhu Added for Exam Management starts
  get 'exam_management/department_wise_employee'
  #Bindhu Added for Exam Management Ends
...
get 'accounts/central_receivable_excel_report'=>'accounts#central_receivable_excel_report'
  ...
  get 'inventory/unique_username/:id'=>'inventory#unique_username',as: :unique_username

  post 'inventory/attachment_delete'
  ...
  get 'inventory/payment_status'=>"inventory#payment_status",as: :payment_status
  get 'inventory/payment_status_report'=>"inventory#payment_status_report",as: :payment_status_report
 ...
 get 'inventory/show_fine_fee_particular'
  ...
  get 'inventory/assign_po/:id' => 'inventory#assign_po'
...
get 'inventory/inventory_room_management'
 ...
 get 'inventory/inventory_goods_purchased'
  ...
  # get 'mg_elective_student_associations/show'

  # get 'mg_elective_groups/index'

  # get 'mg_elective_groups/new'

  # get 'mg_elective_groups/create'

  # get 'mg_elective_groups/edit'

  # get 'mg_elective_groups/update'

  # get 'mg_elective_groups/show'

  # get 'mg_elective_groups/destroy'

  # get 'mg_elective_types/index'

  # get 'mg_elective_types/edit'

  # get 'mg_elective_types/show'

  # get 'mg_elective_types/delete'

  # get 'mg_elective_types/new'

  # get 'mg_elective_types/update'

  # get 'mg_elective_types/create'

  # get 'mg_subject_type/index'

  # get 'mg_subject_type/edit'

  # get 'mg_subject_type/new'

  # get 'mg_subject_type/create'

  # get 'mg_subject_type/update'
...
get 'dashboards/search_vehicle_status'
  ...
  get 'subjects/elective_type'
  get 'subjects/rooms_for_specialization'
  
  get 'mg_elective_student_associations/subject_list'

  resources :front_office_management
  resources :hostel_management

  
  resources :mg_elective_groups

  resources :mg_subject_types
  
  resources :mg_elective_types
  
  resources :mg_elective_student_associations
  resources :exam_management
  resources :alumni
  resources :posts do
    resources :comments
  end
...
get 'payslips/payment'
get 'payslips/updates'
...
get 'library/stack_management'=>'library#stack_management',as: :stack_management
  ...
  #get 'library/resource_type_purchase_list/:id'=>'library#resource_type_purchase_list'
...
get 'curriculum/syllabus_index' , as: :curriculum_syllabus_index
  get 'curriculum/curriculum_search_data'
  get 'curriculum/subject_wise_report_data'
  get 'curriculum/report_data'
  get 'curriculum/curriculum_student_search_data'

  get 'curriculum/search'
  get 'curriculum/student_search'
...
# =========================Curriculum Changes======================================
  ...
  post 'curriculum/attachment_document_delete'
  
  

  #get 'curriculum/attachment_document_delete/:id' => 'subjects#course_list'

  get 'curriculum/notes'
  get 'curriculum/notes_new'                                                            
  post 'curriculum/notes_create' 
  get 'curriculum/notes_show'
  get 'curriculum/notes_edit'
  post 'curriculum/notes_delete'
  patch 'curriculum/notes_update/:id'=>'curriculum#notes_update' , as: :curriculum_notes_update


  get 'curriculum/document'
  get 'curriculum/document_new'                                                            
  post 'curriculum/document_create' 
  get 'curriculum/document_show'
  get 'curriculum/document_edit'
  post 'curriculum/document_delete'
  patch 'curriculum/document_update/:id'=>'curriculum#document_update' , as: :curriculum_document_update




  get 'curriculum/employee_curriculum'
  get 'curriculum/employee_curriculum_new'                                                            
  post 'curriculum/employee_curriculum_create'
  get 'curriculum/employee_curriculum_show'
  post 'curriculum/employee_curriculum_edit'
  post 'curriculum/employee_curriculum_delete'
  patch 'curriculum/employee_curriculum_update/:id'=>'curriculum#employee_curriculum_update' , as: :employee_curriculum_update


  get 'curriculum/review_curriculum'
  get 'curriculum/review_curriculum_new'                                                            
  post 'curriculum/review_curriculum_create'
  get 'curriculum/review_curriculum_show'
  post 'curriculum/review_curriculum_edit'
  post 'curriculum/review_curriculum_delete'
  patch 'curriculum/review_curriculum_update/:id'=>'curriculum#review_curriculum_update' , as: :review_curriculum_update


  get 'curriculum/subject_wise_report'
  get 'curriculum/department_wise_report'
  ...
  get 'curriculum/grade_new'                                                            
  post 'curriculum/grade_create'
  get 'curriculum/grade_show'
  post 'curriculum/grade_edit'
  post 'curriculum/grade_delete'
  patch 'curriculum/grade_update/:id'=>'curriculum#grade_update' , as: :grade_update


  get 'curriculum/course'
  get 'curriculum/course_new'                                                            
  post 'curriculum/course_create'
  get 'curriculum/course_show'
  post 'curriculum/course_edit'
  post 'curriculum/course_delete'
  patch 'curriculum/course_update/:id'=>'curriculum#course_update' , as: :course_update


  get 'employees/document'
  get 'employees/document_new'                                                            
  post 'employees/document_create' 
  get 'employees/document_show'
  post 'employees/document_edit'
  post 'employees/document_delete'
  patch 'employees/document_update/:id'=>'employees#document_update' , as: :document_update

  get 'employees/specialization'
  get 'employees/specialization_new'                                                            
  post 'employees/specialization_create' 
  get 'employees/specialization_show'
  post 'employees/specialization_edit'
  post 'employees/specialization_delete'
  patch 'employees/specialization_update/:id'=>'employees#specialization_update' , as: :specialization_update

  get 'subjects/specialization_verification_list/' => 'subjects#specialization_verification_list'
  

  get 'subjects/course_list/:id' => 'subjects#course_list'
  get 'subjects/elective_group_list/:id' => 'subjects#elective_group_list'

# ================================================================================================
  get 'curriculum/semester_list/:id' => 'curriculum#semester_list'
  get 'curriculum/wing_list/:id' => 'curriculum#wing_list'
  get 'curriculum/semester_batch_list/:id' => 'curriculum#semester_batch_list'
  get 'curriculum/subject_list/:id' => 'curriculum#subject_list'
  get 'curriculum/subject_paper_list/:id' => 'curriculum#subject_paper_list'
  get 'curriculum/subject_department_wise_list/:id' => 'curriculum#subject_department_wise_list'
  # get 'curriculum/report/:id' => 'curriculum#report'
  get 'curriculum/syllabus_list/:id' => 'curriculum#syllabus_list'
  get 'curriculum/unit_list/:id' => 'curriculum#unit_list'
  get 'curriculum/topic_list/:id' => 'curriculum#topic_list'
  get 'curriculum/extention_list/:id' => 'curriculum#extention_list'
  # post 'curriculum/extention_list'
...
post 'curriculum/create' , as: :curriculum_indexes
  ...
  get 'curriculum/subject_edit/:id' => 'curriculum#subject_edit'
  ...
  get 'curriculum/topic_edit/:id' => 'curriculum#topic_edit'
...
get 'timetable/batch_list'=>'timetable#batch_list', as: :batch_list
get 'timetable/mandatory_subject_list'=>'timetable#mandatory_subject_list', as: :mandatory_subject_list
get 'timetable/mandatory_subject'=>'timetable#mandatory_subject', as: :mandatory_subject
get 'timetable/elective_employee_list'=>'timetable#elective_employee_list', as: :elective_employee_list
get 'timetable/elective_subjects'=>'timetable#elective_subjects', as: :elective_subjects
get 'timetable/elective_subject_type'=>'timetable#elective_subject_type', as: :elective_subject_type
get 'timetable/subject_type'=>'timetable#subject_type', as: :subject_type
get 'timetable/mandatory_subject_room'=>'timetable#mandatory_subject_room', as: :mandatory_subject_room
get 'timetable/elective_room_list'=>'timetable#elective_room_list', as: :elective_room_list
resources :timetable
...
get 'schools/room'
  get 'schools/room_new'                                                            
  post 'schools/room_create'
  get 'schools/room_show'
  post 'schools/room_edit'
  post 'schools/room_delete'
  patch 'schools/room_update/:id'=>'schools#room_update' , as: :room_update
...
get 'fees/saveParticularFee'
  ...
  get 'employees/hod_specialization_list'
